    ...
    <table class="w-full text-center" id="myTable">
        ...
        <?php foreach ($feeds as $feed) : ?>
                <tr class="border-b hover:bg-gray-50">
                    <td class="p-3" data-id="<?php echo $feed['id'] ?>">
                    ...
                    <button type="button" class="btn-delete px-2 inline-block" data-id="<?= $feed['id']; ?>" data-action="admin/feedback/delete/<?= $feed['id']; ?>" title="delete">
